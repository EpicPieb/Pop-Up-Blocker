...
public class Gameplay {
    ...
    public void game(Menu menu) { // the actual gameplay
        try{ // god help me
            g = new Gameplay();
            classLoader = Gameplay.class.getClassLoader();
            closed = 0;
    ...
    private static void countdown(Menu menu) {
        try {
            ...
            ImageIcon wtfbruh = new ImageIcon(classLoader.getResource("assets/icon.png"));
    ...
    private static void popupc(Menu menu) { // this is the window that shows timer and counts windows closed
        ...
        try {
            InputStream inputStream = g.getClass().getResourceAsStream("/assets/sounds/vslancer.wav");
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new BufferedInputStream(inputStream));
            clipg = AudioSystem.getClip();
            clipg.open(audioInputStream);
            clipg.loop(Clip.LOOP_CONTINUOUSLY);
            clipg.start();
        }catch(Exception e){ExceptionHandler.handleException(e);}
    ...
    public static void popupcNew() {
        ...
        ImageIcon THISFUCKINGIMAGEICON = new ImageIcon(classLoader.getResource("assets/icon.png"));
    ...
    public static void retard(Menu menu) {
        try{
            ...
            InputStream inputStream = g.getClass().getResourceAsStream("/assets/sounds/fail.wav");
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new BufferedInputStream(inputStream));
