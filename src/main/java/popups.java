...
public class popups {
    ...
    public popups(Menu input) {
        classLoader = popups.class.getClassLoader();
        menu = input;
    }
    ...
    protected static void popup0() {
        ...
        ImageIcon img = new ImageIcon(Objects.requireNonNull(classLoader.getResource("assets/textures/popups/hot chicks.png")));
    ...
    protected static void popup1() {
        ...
        pp1p.setLayout(null);
        ImageIcon gif = new ImageIcon(Objects.requireNonNull(classLoader.getResource("assets/textures/popups/sketchy ass button.gif")));
    ...
    protected static void popup2() {
        ...
        ImageIcon annoy = new ImageIcon(Objects.requireNonNull(classLoader.getResource("assets/textures/popups/annoyingpopup.png")));
    ...
    protected static void popup3() {
        ...
        ImageIcon mor = new ImageIcon(Objects.requireNonNull(classLoader.getResource("assets/textures/popups/MORBIUS.png")));
    ...
    protected static void popup4() {
        ...
        ImageIcon viruses = new ImageIcon(Objects.requireNonNull(classLoader.getResource("assets/textures/popups/virus.png")));
    ...
    protected static  void popup5() {
        ...
        ImageIcon image = new ImageIcon(Objects.requireNonNull(classLoader.getResource("assets/textures/popups/crypto.png")));
    ...
    protected static void popup6() {
        ...
        ImageIcon theImageItselfLMFAO = new ImageIcon(Objects.requireNonNull(classLoader.getResource("assets/textures/popups/robux.png")));
    ...
    protected static void popup7() {
        ...
        ImageIcon thereIsNoMore = new ImageIcon(Objects.requireNonNull(classLoader.getResource("assets/textures/popups/giveaway.png")));
    ...
    protected static void popup8() {
        ...
        ImageIcon asISaidThereIsNoFunnySoundingVariablesAfterThis = new ImageIcon(Objects.requireNonNull(classLoader.getResource("assets/textures/popups/bing.png")));
    ...
    protected static void popup9() {
        ...
        ImageIcon image = new ImageIcon(Objects.requireNonNull(classLoader.getResource("assets/textures/popups/Pop-Up-Blocker.png")));
